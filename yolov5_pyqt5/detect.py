...
# cv2, increment_path, non_max_suppression, print_args, scale_boxes, strip_optimizer, xyxy2xywh)
...
def run(
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        # Define the path for the CSV file 我加的
        csv_path = save_dir / 'predictions.csv'

        # Create or append to the CSV file
        def write_to_csv(image_name, prediction, confidence):
            data = {"Image Name": image_name[:-4], "Prediction": prediction, "Confidence": confidence}
...
if __name__ == '__main__':
    run(weights='weights/teat_score.pt', source='../cow_data/20240328/photos/')